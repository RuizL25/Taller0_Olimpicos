...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le muestra al usuario el pais del atelta si este existe
	 */
	private void ejecutarPaisAtleta()
	{	
		//andreea aanei (Atleta de prueba)
		String atleta = input("Porfavor ingre el nombre de un atleta");
		String respuesta = calculadora.buscarPaisAtleta(atleta);
		if(respuesta != null)
		{
		...
		{
			System.out.println("El atleta no esta registrado en ningun pais");
		}
